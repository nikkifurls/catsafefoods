...
window.addEventListener('load', async () => {
	...
	showPromo({
        text: `Sharing food with your dog, too? Check out <a href='https://dogsafefoods.com' target='_blank'>dogsafefoods.com</a>!`,
        cookieName: 'dogsafefoods.com-promo',
    });
});
 ...
 * Display search results.
 * 
 * @param {Object} displayResultsData Data for the results to display.
	...
	if (!results.length) {
		...
		searchResultsContainer.innerHTML = query
			? `<div class='result'>
				...
				<p><strong>Check with your veterinarian before sharing <em>any</em> food with cats—especially those not found in our database.</strong></p>
			</div>`
			: '';
	} else {
